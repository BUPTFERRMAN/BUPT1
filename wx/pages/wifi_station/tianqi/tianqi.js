...
const devicesId = "642788433" // 填写在OneNet上获得的devicesId 形式就是一串数字 例子:9939133
const api_key = "64XMYp0Sf2gd8yIxMrGASfzwscQ=" // 填写在OneNet上的 api-key 例子: VeFI0HZ44Qn5dZO14AuLbWSlSlI=
...
Page({
  ...
  getDatapoints: function () {
    return new Promise((resolve, reject) => {
      wx.request({
        url: `https://api.heclouds.com/devices/${devicesId}/datapoints?datastream_id=Temperature,Humidity,Distance&limit=20`,
        /**
         * 添加HTTP报文的请求头, 
